namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string SuccessfulLogin="Sisteme başarılı giriş yapıldı";
        public static string UserAlreadyExists="Kullanıcı sistemde zaten kayıtlı";
        public static string AccessTokenCreated="Erişim hakkı oluşturuldu";
    }
}
